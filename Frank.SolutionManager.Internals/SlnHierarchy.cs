...
internal sealed class SlnHierarchy
{
    ...
    ///  • be '.' or '..'
    /// </remarks>
    internal const char Separator = '\u0338';
    ...
    /// </summary>
    internal IEnumerable<SlnFolder> Folders => EnumerateFolders(_rootFolder);

    /// <summary>
    /// Gets the root folder.
    /// </summary>
    internal SlnFolder RootFolder => _rootFolder;
    ...
    internal static SlnHierarchy CreateFromProjectDirectories(
    ...
    internal static SlnHierarchy CreateFromProjectSolutionFolder(
        IReadOnlyList<SlnProject> projects,
        IReadOnlyCollection<string> solutionItems)
    {
