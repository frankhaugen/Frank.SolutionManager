...
internal static partial class ExtensionMethods
{
    ...
    /// </summary>
    internal static readonly char[] EqualsSign = { '=' };
    ...
    internal static IEnumerable<string> GetConditionedPropertyValuesOrDefault(this Project project, string name, string defaultValue)
    {
    ...
    /// <param name="defaultValue">A default values comma separated to return in the case when the property has no value.</param>
    /// <returns>The values of the property if one exists, otherwise the default value specified.</returns>
    internal static IEnumerable<string> GetPossiblePropertyValuesOrDefault(this Project project, string name, string defaultValue)
    {
    ...
    internal static string GetPropertyValueOrDefault(this Project project, string name, string defaultValue)
    {
    ...
    internal static bool IsPropertyValueTrue(this Project project, string name)
    {
    ...
    internal static IEnumerable<KeyValuePair<string, string>> SplitProperties(this string value)
    {
    ...
    internal static IEnumerable<string> SplitSemicolonDelimitedList(this string value)
    {
        if (value.IsNullOrWhiteSpace())
        {
    ...
    internal static IReadOnlyCollection<string> SplitValues(this IEnumerable<string> source)
    {
        if (source == null)
        {
    ...
    internal static string ToSolutionPath(this string path)
    {
        return path.Replace("/", @"\");
    }
    ...
    internal static string ToSolutionPlatform(this string platform)
    {
    ...
    /// </returns>
    internal static string ToSolutionString(this Guid guid, bool uppercase = true)
    {
